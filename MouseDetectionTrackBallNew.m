...
%     DiffLaserOnset = diff(LaserOnsetFrame);
    ...
    ID_ChR2 = knnsearch(ChR2orIR_LaserOnsetFrame,ChR2LaserOnsetFrame);%ChR2orIR_LaserOnsetÇ…ç≈Ç‡ãﬂÇ¢ChR2LaserOnsetÇå©Ç¬ÇØÇÈ
    ID_IR = knnsearch(ChR2orIR_LaserOnsetFrame,LaserOnsetFrame);%ChR2orIR_LaserOnsetÇ…ç≈Ç‡ãﬂÇ¢IRLaserOnsetÇå©Ç¬ÇØÇÈ
